            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu profile-notification ">
                    <ul class="pro-body">
                        ...
                        <li><a href="{{url('pm-list-pms')}}" class="dropdown-item"><i class="fas fa-circle"></i>Project Managers</a></li>
                        <li><a href="{{url('pm-list-centers')}}" class="dropdown-item"><i class="fas fa-circle"></i>Centers</a></li>
                        <li><a href="{{url('pm-list-cms')}}" class="dropdown-item"><i class="fas fa-circle"></i>Center Managers</a></li>
                        <li><a href="{{url('pm-list-trainers')}}" class="dropdown-item"><i class="fas fa-circle"></i>Trainers</a></li>
                        <li><a href="{{url('pm-list-sessions')}}" class="dropdown-item"><i class="fas fa-circle"></i>Sessions</a></li>
