...
<div class="m-header">
    ...
    <a href="{{route('su-admin')}}" class="b-brand">
        ...
        <li class="nav-item">
            <div class="dropdown">
                ...
                <div class="dropdown-menu profile-notification ">
                    <ul class="pro-body">
                        <li><a href="{{url('adm-dashboard')}}" class="dropdown-item"><i class="fas fa-circle"></i> Dashboard</a></li>
                        <li><a href="{{url('adm-pms-list')}}" class="dropdown-item"><i class="fas fa-circle"></i>Project Managers</a></li>
                        ...
                        <li><a href="{{url('adm-profile-edit')}}" class="dropdown-item"><i class="fas fa-circle"></i> Profile</a></li>
                        <li><a href="{{url('adm-tasks')}}" class="dropdown-item"><i class="fas fa-circle"></i> Tasks</a></li>
        ...
        <li>
            <div class="dropdown drp-user">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="{{url('assets/images/user/avatar-2.jpg')}}" title="logged in as {{auth()->user()->name}}" class="img-radius" alt="User-Profile-Image">
                </a>
