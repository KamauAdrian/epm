...
@section('js')
    ...
    <script>
        ...
        // $("#training").children(":nth-child(2)").on("select",function (){
        $("#selected_training").bind("change",function (){
        ...
        console.log($("#selected_training").text());
        console.log($("#multiSelectTraining"));
